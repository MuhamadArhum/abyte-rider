            ...
            <div className="p-3 bg-emerald-50 border border-emerald-200 rounded-xl space-y-2">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-xs font-bold flex items-center justify-center gap-1.5 shadow-2xs transition"
                >
                  <Share2 className="w-3.5 h-3.5" />
                  <span>Send Link / QR</span>
                </button>
                <button
                  onClick={() => window.open(getShareableRiderUrl(rider.id), '_blank')}
                  className="px-3 py-2 bg-white border border-emerald-300 hover:bg-emerald-50 text-emerald-800 rounded-lg text-xs font-bold flex items-center gap-1 transition"
                  title="Open GPS Transmitter page in new tab"
                >
